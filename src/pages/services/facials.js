...
const Facials = ( {data} ) => {
  ...
  useEffect(() => {
    ...
    const hyperpigmentation = windowWidth < 993 && windowWidth >= 576  ? "Hyper Pigmentation" : "Hyperpigmentation"
    ...
    for ( let i = 0 ; i < rows ; i++ ) {
      temp.push(facialServices.slice(i * productsPerRow, i * productsPerRow + productsPerRow))
    }
  ...
  [
    windowWidth, 
    data.acne.childImageSharp.fluid, 
    data.customFacial.childImageSharp.fluid, 
    data.facialDude.childImageSharp.fluid,
    data.dualExfoliation.childImageSharp.fluid, 
    data.hydrafacial.childImageSharp.fluid, 
    data.antiAgingFacial.childImageSharp.fluid, 
    data.maskne.childImageSharp.fluid
  ]
)
